...
RUNNER_NAME="${RUNNER_NAME:-gitea-docker-push-runner}"
RUNNER_LABELS="${RUNNER_LABELS:-docker-push:host,ubuntu-latest:docker://gitea/runner-images:ubuntu-latest,self-hosted:host}"
